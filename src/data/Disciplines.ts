...
export const disciplines: Record<DisciplineName, Discipline> = {
    ...
    celerity: {
        ...
        powers: [
            ...
            {
                name: "Paranoid Haste",
                description: "Time feels like it's in short supply when in the presence of this Kindred. Whether due to the imminent threat of violence or simply the dangers that come when working for a crazed immortal, who can say? If successful then those near you feel a sudden sense of urgency, as though if they do not complete their current task something dreadful might happen. This ability has a curious effect, mechanically speaking. On one hand, repetitive, mundane and simple tasks are more likely to be done quickly, while delicate, complex or difficult tasks are a lot more likely to fail. Mechanically all mundane tasks (generally those that do not rely on knowledge or skill) gain a 2 dice bonus to any of their rolls, while all complicated tasks (those which rely on delicacy or skill) subtract 2 dice from any of their rolls.",
                summary: "Area effect: +2 dice to mundane tasks, -2 dice to complex tasks for those nearby",
                rouseChecks: 1,
                amalgamPrerequisites: [{ discipline: "dementation", level: 1 }],
                dicePool: "Celerity + Dementation",
                level: 1,
                discipline: "celerity",
            },
            {
                name: "Rapid Fleshworks",
                description: "Expediency, rather than creativity, is this Fiend's preference. The user halves the normal time requirements to manifest any of his Vicissitude effects. The user can voluntarily apply this upgrade to any of his Vicissitude abilities. However, if he does decide to apply the upgrade and rolls a 1 on any required Rouse Checks then the augmented ability automatically fails as the modification runs out of control. If the user is targeting himself with a Vicissitude ability and this occurs, then the power fails and they suffer a point of Aggravated Health Damage.",
                summary: "Upgrade: Halve Vicissitude casting time, but risk of failure and damage on bad Rouse Checks",
                rouseChecks: 0,
                amalgamPrerequisites: [{ discipline: "vicissitude", level: 1 }],
                dicePool: "None",
                level: 1,
                discipline: "celerity",
            },
            ...
            // Amalgams  
            { name: "Cain's Cleaver", description: "The user has combined his powers with a specialized blade to produce truly murderous results. To use this power the vampire needs to wield a large-bladed weapon (at least the size of their forearm). When injuring targets with the blade the victim cannot halve the damage received and the blade adds a +2-damage modifier, if wielded single handedly, or a +3-damage modifier if wielded with both hands. Unfortunately, the user's strikes are so fast and so powerful they will eventually destroy the weapon. However, if the user manages to obtain a specialized blade, one which is tempered to be able to handle heavy blows (left to the discretion of the Storyteller), then the blade can perform near-impossible feats, such as cutting through a steel chain, hacking through another weapon with ease and cutting through shields and armour as though they were paper.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "potence", level: 1 }], summary: "Bladed weapons deal enhanced damage and can cut through nearly anything.", dicePool: "None", level: 1, discipline: "celerity" },
            { name: "Curse Of Years", description: "As the vampire places their hands on a mortal it seems time progresses rapidly for the victim, essentially ageing them at a rapid pace. If successful, the target is aged by a factor of up to 10 years per dot the user has in Celerity. Unfortunately, the power does not affect Kindred or children (those under the age of 18). Ghouls are impacted but nothing changes for them unless they stop receiving their master's blood in which case all the years catch up with them.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "protean", level: 2 }], summary: "Age mortals by up to 10 years per Celerity dot through touch.", dicePool: "Celerity + Protean", level: 2, discipline: "celerity" },
            { name: "A Moment Of Eternity", description: "Time seems to stretch out and slow for the user. For a few brief moments, they can see their surroundings, unaffected by time itself. This Upgrade is allowed to be used once per Scene. The user can perform a Wits + Awareness roll to investigate a particular target or their general surroundings. This roll is unaffected by the chaos of the moment, giving the user a valuable ability to assess their surroundings or a particular target calmly. They can then apply the knowledge gleaned towards their next action accordingly. This analysis of the situation occurs outside of the normal order of play (in between two Rounds).", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "auspex", level: 2 }], summary: "Once per scene, analyze situation with unaffected Wits + Awareness roll outside normal play order.", dicePool: "Wits + Awareness", level: 2, discipline: "celerity" },
            { name: "Flower of Alamut", description: "The Banu Haqim are the undisputed blade masters of the Cainite world. Many have sought to imitate their fighting style, but few can hope to ever equal their mastery. If successful, the user masterfully cuts the tendons in one of the target's limbs, immobilising them and leaving them helpless. For every 2 successes, after achieving the test's minimum requirements, the user can immobilize an additional limb (arms, legs, tentacles, wings, tails...). Each such strike causes 1 point of Aggravated Damage in addition to the power's normal effects. Additional damage modifiers are otherwise not applied as the user is trying to incapacitate rather than kill the target.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "quietus", level: 2 }], summary: "Immobilize limbs with precise tendon cuts, +1 Aggravated damage per limb.", dicePool: "Celerity + Quietus", level: 2, discipline: "celerity" },
            { name: "Command Gusto", description: "The Vampire instils a sense of urgency and a want to succeed in those they Dominate. Any of your victims, gain a 2 dice bonus for any Physical Actions they are undertaking, that are directly in the pursuit of one of your Dominate orders.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "dominate", level: 2 }], summary: "Upgrade: Dominated victims get +2 dice to Physical actions pursuing your orders.", dicePool: "None", level: 2, discipline: "celerity" },
            { name: "Mesmerizing Dance", description: "As the Vampire takes to the dance floor, mortals can do little to stop themselves from joining in. To use this ability the Kindred should be in a setting where there is music. A penalty is applied to any Resistance Roll if the ability is performed in a location where dancing is expected (a ballroom, a party, a night club etc). If successful, then all those within Visual Range of the user will find a need to join them on the dance floor. As the victims do so they completely lose themselves in the ongoing festivities, so much so that they will be completely ignorant of anything else going on around them. A fellow dancer can be fed upon, gutted, shot or even dismembered in front of them, and they would do nothing but continue dancing, so strong is the spell the Kindred had placed upon them. Their memories are also impacted, and the experience is similar to waking up from a drug-fuelled state, being able to only remember a portion of the events which occurred and even then, a clear picture is hard to grasp.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "presence", level: 2 }], summary: "Force all in visual range to dance and lose awareness of surroundings, requires Dancing specialization.", dicePool: "Celerity + Presence", level: 2, discipline: "celerity" },
            { name: "Momentum's Might", description: "The Kindred combines the resilience of Fortitude with the unnatural speed of Celerity to turn themselves into an unstoppable opponent, sometimes literally. The user can launch a free Stamina + Brawl action at the end of any activated Celerity power, which brings them within striking distance of a target. This free action will automatically strike the opponent unless they have some form of Supernatural speed or ability to predict the incoming attack.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "fortitude", level: 3 }], summary: "Free automatic attack after Celerity powers that bring you within striking distance.", dicePool: "Stamina + Brawl", level: 3, discipline: "celerity" },
            { name: "Arachnid Horror", description: "The vampire's form shifts and mutates until dozens of monstrous appendages sprout from their body granting them a horrible degree of speed, dexterity and lethality. If successful, the user's form is altered with insectoid-like features. This could mean their lower half resembles that of a spider or centipede or other similar insectoid-like appendages sprout from their back or sides. Whatever form it takes the user receives the following bonuses: Unrivalled Dexterity: The user effectively benefits from the Celerity power of Cats Grace and Fleetness. Sharpened Limbs: Damage from the user's unarmed attacks ignores armour and cannot be halved. Extra Appendages: The user adds 2 dice to any Brawl and Athletics roll they make. Fleshcrafted Horror: Mortals and Enhanced Mortals must pass a Willpower test (3) or flee the Scene in horror.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "vicissitude", level: 3 }], summary: "Transform into arachnid horror with enhanced speed, armor-piercing attacks, and terrifying appearance.", dicePool: "Celerity + Vicissitude", level: 3, discipline: "celerity" },
            { name: "The Beheading", description: "The user cuts his palm on the blade, allowing the vitae to bloody it before focusing on the blade itself. Once they are ready to strike the blade cuts the air with incredible swiftness, its edge an extension of the Vampire's own body. The blade cuts through stone, metal and flesh, even that of an elder, with horrifying ease. To perform this ability the following is needed: The user must possess a sword or large blade. The user must cut their own palm on the blade and allow the vitae to cover the weapon (2 Rouse Checks). The user then teleports to the target (in the same manner as if they were using Blink) and must successfully strike it using a Dexterity + Melee roll. If all these conditions are met the user will automatically inflict 5 points of Aggravated Health Damage on a target. This damage cannot be negated or reduced by any powers which are not ranked as Level 5 or higher. The user can also use this attack to cut through any material, be it physical or spiritual, so even spiritual entities such as Wraiths are not safe from its terrible power. Once the damage is made the blade shatters into a dozen smaller pieces.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "quietus", level: 4 }], summary: "Teleport strike with vitae-enhanced blade dealing 5 Aggravated damage, cuts through any material.", dicePool: "Celerity + Quietus", level: 4, discipline: "celerity" },
            { name: "Artemis's Malediction", description: "A bite from this Kindred quickens a Vampire's bestial hunger. The user can voluntarily inflict this curse upon any Kindred or Thin-Blood they bite. The victim must make an extra Rouse Check for each power they use, excluding upgrades. Furthermore, each time the victim rolls a 1 on a Rouse Check they automatically increase their Hunger to 5 and risk a Hunger Frenzy. The power is treated as a Poison for the purposes of Resisting its effects.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "animalism", level: 4 }], summary: "Bite curse causing extra Rouse Checks and Hunger 5 on natural 1s, lasts 3 nights.", dicePool: "None", level: 4, discipline: "celerity" },
            { name: "Ulyana's Final Act", description: "Taking its name from a famous Kindred ballerina, this power stuns those who see it with its pure elegance and grace. The vampire spins and pirouettes, dancing beautifully towards its intended target, before tearing into them. As the victim's guts and blood seep onto the floor, they can do little but keep watching the murderous ballerina as she continues her performance. If successful, the user will start to dance as they move. While dancing the user is still able to perform most actions normally; they can move, defend themselves and launch attacks without issue. However, all those observing the user must pass a Resistance Roll each Round or be unable to act. This applies even if the user is actively attacking them.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "presence", level: 4 }], summary: "Mesmerizing dance that incapacitates observers while user can act normally, requires Dancing specialization.", dicePool: "Celerity + Presence", level: 4, discipline: "celerity" },
        ],
    },
    chimestry: {
        clans: [
    ...
    dementation: {
        ...
        powers: [
            ...
            // Amalgams
            { name: "Broken Mirror", description: "The mind of a Malkavian is a horrible place to invade. This power can be used in one of two ways. If successful it has the following effects: When used against a mental command, that would see the user act against their will, it will rebound the last order the user received back at the individual trying to Dominate them. So, if an individual orders the user to punch themselves, the order is instead carried out by the individual who uttered the command. When used against any form of mental intrusion, the invasive power automatically fails and the invader is subject to the user's own Clan Compulsion (even if they do not belong to the same clan), which immediately starts to impact them. ❖ Type: Reflexive ❖ Tag: Mental ❖ Range & Targets: Anyone who is currently targeting the user with mental effects. The power can be activated even if the user is unaware, they are being manipulated as their mind automatically reacts to protect itself. ❖ Cost: 1 Rouse Check ❖ Conditions: Only works against purely Mental powers. ❖ Risk: Low. This ability merely turns the tables on those who would seek to manipulate the user to begin with. ❖ Test: Dementation + Dominate (4) ❖ Resistance Roll: None ❖ Duration: If it is a command then the effects of this power last until the command is carried out. If it is a mental intrusion, then the intruder is impacted by the user's clan compulsion until the end of the Session.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dominate", level: 3 }], summary: "Reflect mental commands/intrusions back at attacker, imposing clan compulsion", dicePool: "Dementation + Dominate", level: 3, discipline: "dementation" },
            { name: "Nightmare Eater", description: "A traumatic experience for those who suffer from phobias, yet if one is strong enough to face their fears, they will discover newfound resolve. This ability can only be used on those who suffer from phobias. If successful, the user imparts a portion of their illusionary powers upon the victim. This causes the target's phobias to manifest as illusions around them at random, but only when they are completely alone. In essence, this creates a situation where the victim is forced to endure their worst fears alone while being completely powerless to prove the validity of the illusions. The victim must pass a Willpower test every 24 hours the power lasts. Each time they fail they will suffer an Aggravated point of Willpower damage. While the power is in effect the target can only recover Superficial Willpower Damage by resting, but never Aggravated. The effects of the power last either for 1 month, until the victim's Willpower tracker is filled with Aggravated Damage or until they pass their Resistance Roll 3 consecutive times.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "chimerstry", level: 1 }], summary: "Target with phobias experiences fear illusions alone, can cure phobia or drive to suicide.", dicePool: "Chimerstry + Dementation", level: 1, discipline: "dementation" },
            { name: "The Specter Of Justice", description: "The victim is haunted by a spirit only he can see. Although ever present, the spirit only materializes to its victim when they are about to commit an act which is considered morally wrong. If successful, a spirit will materialize in front of the victim every time they are about to commit an act which the Storyteller considers morally wrong. The spirit itself is just a trick and is completely conjured by the mind of the victim (an echo of their subconscious morality). Nobody else can see the spirit or interact with it. The spirit itself is terrifying to the victim and keeps them in check while the power lasts. Mechanically speaking the victim applies a 2 dice penalty to any roll associated with an action that the Storyteller deems morally wrong.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "valeren", level: 2 }], summary: "Ritual: Haunting spirit that penalizes morally wrong actions.", dicePool: "Dementation + Valeren", level: 2, discipline: "dementation" },
            { name: "Pandemonium's Ringleader", description: "A wave of fear and anger pushes those near the user into a terrible frenzy. If successful, roll a D10 and apply the results. Evens – If the result is an even number, then all those who fail their Resistance Roll are sent into a fear Frenzy. The individuals cannot verbalize or point to what they are afraid of, but they all flee away from the user. Do note that those affected are in a Frenzy and will attack anyone who gets in their way. Odds – If the result is an odd number, then all those who fail their Resistance Roll are sent into an anger Frenzy and will attack the nearest target (usually each other) with murderous intent.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dominate", level: 2 }], summary: "Random frenzy effect on all within 30 feet - fear or anger frenzy based on D10 roll.", dicePool: "Dementation + Dominate", level: 2, discipline: "dementation" },
            { name: "Moon Kissed Blades", description: "The user coats a blade in his own vitae. Any nick or cut inflicted causes visions of madness to haunt the victim. If successful, the user smears a blade with his blood. For the rest of the evening, any individual injured by the blade will develop the same Mental Derangement the user possesses and will be unable to shake it for the next 3 nights. This form of madness also marks the victim within the Madness Network and the user can instinctively trace down his target, regardless of the distance between them.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "quietus", level: 3 }], summary: "Coat blade with vitae to inflict madness and enable tracking of victims.", dicePool: "Dementation + Quietus", level: 3, discipline: "dementation" },
            { name: "Elimelech's Retreat", description: "The Kindred commands their target to physically transform by their will to power. The subject's body becomes more frail and sickly, but their will becomes overwhelming. If successful, the target's Stamina is reduced by 3 dots, but their Resolve is increased by 3 dots for the duration of the power. The target becomes noticeably more sickly in appearance - pale, gaunt, and weak-looking. However, their mental fortitude becomes virtually unshakeable.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dominate", level: 4 }], summary: "Reduce target's Stamina by 3, increase their Resolve by 3.", dicePool: "Dementation + Dominate", level: 4, discipline: "dementation" },
        ],
    },
    dominate: {
        clans: [
        ...
        powers: [
            ...
            // Amalgams
            { name: "Obey The Pyramid", description: "The Tremere control over their members is unconditional and tyrannical. If successful, the user can automatically use and pass any Dominate powers on the victim of this ritual. The target automatically counts as failing all Resistance Rolls against it and the user only has to make the necessary Rouse Checks (if any) for their powers to succeed.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "blood sorcery", level: 1 }], summary: "Ritual: Automatic success on all Dominate powers against Tremere/Blood Sorcery users.", dicePool: "Blood Sorcery + Dominate", level: 1, discipline: "dominate" },
            { name: "The Scales Of Set", description: "Setites have often debated whether Set was the god of serpents or serpents are the children of Set. This ritual suggests the latter. If successful, the user performs an hour-long ritual which ends with him spitting his vitae onto a patch of bare earth. His blood seeps into the ground and after a few moments dozens of snakes erupt from the soil. The serpents are under his complete mental domination and will follow his every command. Commands do not need to be verbal and the user has a supernatural link with his 'children'. The snakes can be used as spies, to deliver messages or even to attack (although individually each snake poses little threat).", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "serpentis", level: 2 }], summary: "Ritual: Create dozens of controlled snakes from your vitae and earth.", dicePool: "Dominate + Serpentis", level: 2, discipline: "dominate" },
            { name: "Broken Mirror", description: "The mind of a Malkavian is a horrible place to invade. This power can be used in one of two ways. If successful it has the following effects: When used against a mental command, that would see the user act against their will, it will rebound the last order the user received back at the individual trying to Dominate them. So, if an individual orders the user to punch themselves, the order is instead carried out by the individual who uttered the command. When used against any form of mental intrusion, the invasive power automatically fails and the invader is subject to the user's own Clan Compulsion (even if they do not belong to the same clan), which immediately starts to impact them. ❖ Type: Reflexive ❖ Tag: Mental ❖ Range & Targets: Anyone who is currently targeting the user with mental effects. The power can be activated even if the user is unaware, they are being manipulated as their mind automatically reacts to protect itself. ❖ Cost: 1 Rouse Check ❖ Conditions: Only works against purely Mental powers. ❖ Risk: Low. This ability merely turns the tables on those who would seek to manipulate the user to begin with. ❖ Test: Dementation + Dominate (4) ❖ Resistance Roll: None ❖ Duration: If it is a command then the effects of this power last until the command is carried out. If it is a mental intrusion, then the intruder is impacted by the user's clan compulsion until the end of the Session.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dementation", level: 3 }], summary: "Reflect mental commands/intrusions back at attacker, imposing clan compulsion", dicePool: "Dementation + Dominate", level: 3, discipline: "dominate" },
            { name: "The Specter Of Justice", description: "The victim is haunted by a spirit only he can see. Although ever present, the spirit only materializes to its victim when they are about to commit an act which is considered morally wrong. If successful, a spirit will materialize in front of the victim every time they are about to commit an act which the Storyteller considers morally wrong. The spirit itself is just a trick and is completely conjured by the mind of the victim (an echo of their subconscious morality). Nobody else can see the spirit or interact with it. The spirit itself is terrifying to the victim and keeps them in check while the power lasts. Mechanically speaking the victim applies a 2 dice penalty to any roll associated with an action that the Storyteller deems morally wrong.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "blood sorcery", level: 2 }], summary: "Ritual: Haunting spirit that penalizes morally wrong actions.", dicePool: "Blood Sorcery + Dominate", level: 2, discipline: "dominate" },
            { name: "Coat Of A Thousand Tears", description: "There are numerous reasons why one wouldn't want to be taken alive by the Fiends. This horrid ritual is somewhere at the top of the list. For this ritual to work a restrained (and living) or torpored individual is needed. During the ritual, the user will use their fleshcrafting abilities to remove the victim's internal organs, bones and flesh, but leave the skin, vocal cords and heart undamaged. The heart will be contained in a flesh sack and moved underneath the skin to the 'flesh suits' back. The user will then strip down, put the flesh suit on them and swallow the vocal cords. In this guise, they will look and sound exactly like their victim. Worse still, as the victim's heart is preserved, the flesh suit is technically still alive in a fashion (although the victim likely very much wishes they weren't) and so the aura the user produces mimics that of the victim while obscuring their own.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "protean", level: 2 }], summary: "Ritual: Create flesh suit from victim for perfect disguise with victim's aura.", dicePool: "Dominate + Protean", level: 2, discipline: "dominate" },
            { name: "Nightmare Eater", description: "A traumatic experience for those who suffer from phobias, yet if one is strong enough to face their fears, they will discover newfound resolve. This ability can only be used on those who suffer from phobias. If successful, the user imparts a portion of their illusionary powers upon the victim. This causes the target's phobias to manifest as illusions around them at random, but only when they are completely alone. In essence, this creates a situation where the victim is forced to endure their worst fears alone while being completely powerless to prove the validity of the illusions. The victim must pass a Willpower test every 24 hours the power lasts. Each time they fail they will suffer an Aggravated point of Willpower damage. While the power is in effect the target can only recover Superficial Willpower Damage by resting, but never Aggravated. The effects of the power last either for 1 month, until the victim's Willpower tracker is filled with Aggravated Damage or until they pass their Resistance Roll 3 consecutive times.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "obfuscate", level: 1 }], summary: "Target with phobias experiences fear illusions alone, can cure phobia or drive to suicide.", dicePool: "Dominate + Obfuscate", level: 1, discipline: "dominate" },
            { name: "Command Gusto", description: "The Vampire instils a sense of urgency and a want to succeed in those they Dominate. Any of your victims, gain a 2 dice bonus for any Physical Actions they are undertaking, that are directly in the pursuit of one of your Dominate orders.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "celerity", level: 2 }], summary: "Upgrade: Dominated victims get +2 dice to Physical actions pursuing your orders.", dicePool: "None", level: 2, discipline: "dominate" },
            { name: "Pandemonium's Ringleader", description: "A wave of fear and anger pushes those near the user into a terrible frenzy. If successful, roll a D10 and apply the results. Evens – If the result is an even number, then all those who fail their Resistance Roll are sent into a fear Frenzy. The individuals cannot verbalize or point to what they are afraid of, but they all flee away from the user. Do note that those affected are in a Frenzy and will attack anyone who gets in their way. Odds – If the result is an odd number, then all those who fail their Resistance Roll are sent into an anger Frenzy and will attack the nearest target (usually each other) with murderous intent.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dementation", level: 2 }], summary: "Random frenzy effect on all within 30 feet - fear or anger frenzy based on D10 roll.", dicePool: "Dementation + Dominate", level: 2, discipline: "dominate" },
            { name: "Thief Of Falsehoods", description: "The user's Dominate skills extend to the imagined and the unreal, much to the shock of many a trickster. If successful the user can hijack, modify or even command any illusion they encounter. This could be something as simple as changing small details about the illusion or rewriting it completely. The only limit is the user's own skill in Chimerstry. When it comes to the illusion's original owner, they find they have completely lost any sense of control over the illusions they had conjured, can no longer end their illusions on a whim, nor cast new ones as the existing illusions are still powered by them, subconsciously.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "chimestry", level: 2 }], summary: "Hijack and control illusions from other sources, original caster loses control.", dicePool: "Chimerstry + Dominate", level: 2, discipline: "dominate" },
            { name: "Crown The King", description: "Wielding Dominate and Presence in equal measure, this Vampire is an undisputed lord amongst mortals. The user adds 3 dice to any Dominate and/or Presence roll he makes.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "presence", level: 3 }], summary: "+3 dice to all Dominate and Presence rolls.", dicePool: "None", level: 3, discipline: "dominate" },
            { name: "Dominion's End", description: "This blood curse is subtle but relentless. Over time it will weaken and destroy those who rely on Dominate. If successful, the target is cursed for the next 2 weeks. During this time their curse will grow progressively worse, each time they use any form of Dominate power. 1st use: the user grows hungrier even if they passed their Rouse check. 2nd use: the power fails automatically. 3rd use: the user must roll two additional Rouse checks. 4th use: the user marks half of their unmarked Willpower squares with Aggravated Damage. 5th use: the user immediately enters an Anger Frenzy and the power fails. 6th use: the user's mouth continuously fills with their blood until the curse passes. 7th use: the user's eyes liquefy, the power fails, they receive one point of Aggravated Health Damage and are blinded until the curse passes.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "quietus", level: 3 }], summary: "Ritual: Blood curse that progressively weakens Dominate users over 2 weeks.", dicePool: "Dominate + Quietus", level: 3, discipline: "dominate" },
            { name: "Mind Breaking Request", description: "The user makes the effects of their Dominate abilities permanent, by physically re-arranging the target's brain matter. From this point on, if the user is physically touching their target while using a Dominate power, then they add 3 dice to any Dominate roll they make; however, the power is more likely to cause permanent brain damage than normal as the user is subtlety altering their victim's brain physically. If the result of any of the user's Rouse Checks, when using Dominate while touching their target, is a 1 then the victim will suffer a brain stroke immediately and either die or sustain permanent brain injury if assistance doesn't arrive soon (with the power itself failing entirely).", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "protean", level: 2 }], summary: "Upgrade: +3 dice to Dominate while touching, risk of brain stroke on Rouse Check 1.", dicePool: "None", level: 2, discipline: "dominate" },
            { name: "Draught Of Odin", description: "Named after the Norse god of wisdom and war, this fearsome power combines mental domination with supernatural strength to create an unstoppable warrior. The vampire can command their target to drink a mixture of the vampire's blood and that of a defeated enemy, imbuing the drinker with both supernatural loyalty and incredible physical might. The dominated subject becomes a berserker champion, fighting with inhuman strength while being utterly devoted to their master.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "potence", level: 3 }], summary: "Create berserker champion with enhanced strength and absolute loyalty.", dicePool: "Dominate + Potence", level: 4, discipline: "dominate" },
            { name: "Elimelech's Retreat", description: "The Kindred commands their target to physically transform by their will to power. The subject's body becomes more frail and sickly, but their will becomes overwhelming. If successful, the target's Stamina is reduced by 3 dots, but their Resolve is increased by 3 dots for the duration of the power. The target becomes noticeably more sickly in appearance - pale, gaunt, and weak-looking. However, their mental fortitude becomes virtually unshakeable.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dementation", level: 4 }], summary: "Reduce target's Stamina by 3, increase their Resolve by 3.", dicePool: "Dominate + Dementation", level: 4, discipline: "dominate" },
        ],
    },
    fortitude: {
        clans: [
        ...
        powers: [
            ...
            // Amalgams
            { name: "Enduring Darkness", description: "Normally Obtenebration users are limited by ambient light when facilitating the formation of their shadow constructs. However, some had learned techniques to overcome such limitations. The user can voluntarily perform an extra Rouse Check when using Obtenebration powers (if you are not using Obtenebration Remastered then this upgrade can be used on any Oblivion power which uses shadow constructs, such as Arms Of Ahriman). If the extra Rouse Check is performed, then the shadow constructs generated can only be disrupted by the light of the sun itself or direct contact with fire.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "obtenebration", level: 1 }], summary: "Extra Rouse Check makes shadow constructs only disrupted by sunlight/fire.", dicePool: "Rouse Check", level: 1, discipline: "fortitude" },
            { name: "Stalwart Charisma", description: "The weight of this Kindred's will is such that he inspires his allies to unquestionable heights of heroism. If successful, all of the user's allies (but not the user himself), within Visual range of the user, will be immune to all fear-causing effects, whether they originate from mundane intimidation or supernatural sources (including the fear or Fire).", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "presence", level: 1 }], summary: "Allies in visual range become immune to all fear-causing effects.", dicePool: "Presence + Fortitude", level: 1, discipline: "fortitude" },
            { name: "Draught of Emptiness", description: "Often used by offshoots of the Family on valued servants and allies who do not share their proud heritage. The Kindred can voluntarily offer some of its blood to another vampire. If it does so then the target will gain one Oblivion power, which the Kindred already possesses, up to level 2. While the power itself is considered an upgrade, a Rouse Check still needs to be made each time the Kindred feeds a target some of their blood. Any Ghouls you possess will manifest a permanent Level 1 Oblivion power (if they do not have one already) when you next feed them your vitae but due to Oblivion's detrimental effects will also lose 1 point of Health permanently (rounding it down to 1 at most).", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "oblivion", level: 2 }], summary: "Give Oblivion powers to others via blood, ghouls lose 1 Health permanently.", dicePool: "None", level: 2, discipline: "fortitude" },
            { name: "Kupala's Auspice", description: "Kolduns are often forced to face powerful elemental spirits in a bid to dominate the energies of the land itself. If successful, the Kindred can choose to be resilient against one of the 4 elements. They may select ONE of the following bonuses, for each Rouse Check they make, when the test for the Ritual is passed: Earth: The user is resilient to any blunt force trauma (being struck by a blunt weapon, fists, hit by a car etc....) and halves damage from such sources twice (rounding down). Aggravated damage cannot be halved. Air: The user is resilient to any cuts or bladed weapons (blades, arrows, teeth and claws all fall under this category) and reduces damage from all such sources by 2 points (to a minimum of 1). Water: The user is resilient to the effects of poisons and doubles their dice pool for any Resistance Roll against them or, if there is no Resistance Roll available, they must pass a Stamina + Strength test (3) to resist its effects. Fire: The user can ignore the very first instance of fire-based damage received after this power is used. After this bonus is used once it is lost until the Ritual is cast again.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "koldunic sorcery", level: 2 }], summary: "Ritual: Choose elemental resistance - Earth/Air/Water/Fire with specific bonuses.", dicePool: "Fortitude + Koldunic Sorcery", level: 2, discipline: "fortitude" },
            { name: "Carry The Burden", description: "The vampire channels their innate resilience to bear the weight of another's suffering, literally taking their pain into themselves. Through a combination of supernatural fortitude and divine compassion, the vampire can absorb injuries, ailments, or even spiritual burdens from others, healing them while taking the damage upon their own immortal form. This power represents the ultimate sacrifice - using one's undead nature as a vessel for redemption.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "valeren", level: 3 }], summary: "Transfer injuries and suffering from others to yourself, healing them.", dicePool: "Fortitude + Valeren", level: 4, discipline: "fortitude" },
            { name: "Crimson Liberation", description: "This power allows the vampire to break the blood bonds and supernatural controls that bind both animals and people through a combination of primal instincts and supernatural resilience. The vampire channels their inner beast while simultaneously tapping into their undead fortitude to shatter mental chains, freeing victims from vampiric domination, blood bonds, and other forms of supernatural mental control.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "animalism", level: 3 }], summary: "Break blood bonds and supernatural mental controls through primal liberation.", dicePool: "Fortitude + Animalism", level: 4, discipline: "fortitude" },
            { name: "Inner Jackal", description: "The Kindred's inner beast abhors the idea of being manipulated and protects its host's mind from all forms of mental intrusions, if only for its own benefit. The user's mind is shielded by the Beast itself, granting him the following bonuses: +2 dice to any Resistance roll against Dominate or Presence; any mental/spiritual intrusion seeking to discern the user's true nature will halve its dice roll or fail automatically if no roll is required; all Animalism abilities which target the user's beast fail automatically. The beast itself becomes more active, having full conversations with its host and providing them with advice.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "animalism", level: 3 }], summary: "Beast protects mind from mental intrusion, +2 dice vs Dominate/Presence, halves spiritual detection.", dicePool: "None", level: 3, discipline: "fortitude" },
            { name: "Momentum's Might", description: "The Kindred combines the resilience of Fortitude with the unnatural speed of Celerity to turn themselves into an unstoppable opponent, sometimes literally. The user can launch a free Stamina + Brawl action at the end of any activated Celerity power, which brings them within striking distance of a target. This free action will automatically strike the opponent unless they have some form of Supernatural speed or ability to predict the incoming attack.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "celerity", level: 3 }], summary: "Free automatic attack after Celerity powers that bring you within striking distance.", dicePool: "Stamina + Brawl", level: 3, discipline: "fortitude" },
            { name: "Idolater Of The False Gods", description: "The Kindred venerates dark powers while maintaining an appearance of divine favor. They can invoke protective blessings that make them appear touched by holiness while actually drawing power from darker sources. The vampire gains resistance to holy symbols and blessed weapons (treating them as normal weapons), and can walk on consecrated ground without penalty. However, they must regularly perform acts of false worship to maintain this protection.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "serpentis", level: 4 }], summary: "Resist holy symbols and consecrated ground through false worship.", dicePool: "Fortitude + Serpentis", level: 4, discipline: "fortitude" },
        ],
    },
    obfuscate: {
        clans: [
    ...
    potence: {
        ...
        powers: [
            ...
            // Amalgams
            { name: "Forceful Resurface", description: "As the Kindred places their hand on soil, an invisible pulse is sent through the surrounding earth. Felt as a small tremor by most, it violently expels those entities hiding underground. If successful, all supernatural entities which are currently hiding or travelling through the earth via supernatural means (such as Earth Meld) are violently forced to the surface, as if the ground itself had grown hostile to their presence. Their bodies are cut and torn during this process. They suffer 1 point of Aggravated Damage while resurfacing and are stunned for the 1Round (a few seconds) after emerging.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "koldunic sorcery", level: 1 }], summary: "Force underground supernatural entities to surface violently with damage.", dicePool: "Koldunic Sorcery + Potence", level: 1, discipline: "potence" },
            { name: "Cain's Cleaver", description: "The user has combined his powers with a specialized blade to produce truly murderous results. To use this power the vampire needs to wield a large-bladed weapon (at least the size of their forearm). When injuring targets with the blade the victim cannot halve the damage received and the blade adds a +2-damage modifier, if wielded single handedly, or a +3-damage modifier if wielded with both hands. Unfortunately, the user's strikes are so fast and so powerful they will eventually destroy the weapon. However, if the user manages to obtain a specialized blade, one which is tempered to be able to handle heavy blows (left to the discretion of the Storyteller), then the blade can perform near-impossible feats, such as cutting through a steel chain, hacking through another weapon with ease and cutting through shields and armour as though they were paper.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "celerity", level: 1 }], summary: "Bladed weapons deal enhanced damage and can cut through nearly anything.", dicePool: "None", level: 1, discipline: "potence" },
            { name: "Hollow Clap", description: "With a resounding clap, all sound is temporarily muffled. If successful, then the user performs a loud clap. All those within earshot will hear a continuous echo of the clap repeat itself. This echo will obscure all other sounds and only the user's own words can be heard or understood.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "obfuscate", level: 2 }], summary: "Loud clap creates echo that obscures all sounds except user's voice.", dicePool: "Obfuscate + Potence", level: 2, discipline: "potence" },
            { name: "Shadow Strike", description: "A narrow set of shadows shoots from the darkened corners of the room to impale the victim. If successful, the user can strike an opponent with missiles made from pure shadows. These projectiles always originate from the darkest corner of any room or open area and their impact is similar to being struck by an arrow. Although each such strike only causes a single point of Aggravated Damage to Mortals and Enhanced Mortals, and 2 points of Superficial Damage (damage can be halved) to Supernatural Creatures, it grows more potent with the user's Obtenebration rating.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "obtenebration", level: 2 }], summary: "Shadow projectiles from dark corners causing damage based on Obtenebration level.", dicePool: "Obtenebration + Potence", level: 2, discipline: "potence" },
            { name: "Strike The Ley Lines", description: "The user seems to strike empty air at first only for the world around to shudder. Ley Lines are lines of spiritual energy that crisscross the world. Each Ley Line is a font of spiritual energy which is highly sought after by Mages, Cainite Sorcerers, Garou and other creatures. They are invisible to those without supernatural senses and extremely rare. This power acts as an Upgrade and an Ability. As an Upgrade, the user can sense and see Ley Lines when near them (within 10 meters or 30 feet). As an Ability, the user projects a portion of their spirit into their fists to strike the Ley Line itself. As Ley Lines are the equivalent of a major artery for the spiritual world the result of striking them can vary.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "auspex", level: 2 }], summary: "Strike Ley Lines for varied powerful effects, can sense Ley Lines.", dicePool: "Auspex + Potence", level: 2, discipline: "potence" },
            { name: "Agustus's Rebuke", description: "Named after the ancient Cappadocian who first developed this technique, this power combines raw physical might with necromantic energy to deliver devastating attacks against the undead. The vampire channels death energy through their limbs, making their physical strikes particularly potent against other vampires and supernatural creatures. When striking supernatural targets, the attack bypasses normal defenses and deals damage that cannot be easily healed.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "necromancy", level: 3 }], summary: "Physical attacks deal enhanced damage to supernatural creatures, bypass defenses.", dicePool: "Potence + Necromancy", level: 4, discipline: "potence" },
            { name: "Draught Of Odin", description: "Named after the Norse god of wisdom and war, this fearsome power combines mental domination with supernatural strength to create an unstoppable warrior. The vampire can command their target to drink a mixture of the vampire's blood and that of a defeated enemy, imbuing the drinker with both supernatural loyalty and incredible physical might. The dominated subject becomes a berserker champion, fighting with inhuman strength while being utterly devoted to their master.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "dominate", level: 3 }], summary: "Create berserker champion with enhanced strength and absolute loyalty.", dicePool: "Potence + Dominate", level: 4, discipline: "potence" },
            { name: "Shadowlands Quake", description: "The practitioner strikes the ground with their fist and the spirits of undeath around them cry in agony. If successful, the user strikes the ground. As he does so a wave of Shadowlands energy surges through the area which has the following impact: All corpses are momentarily re-animated and enter a frenzy attacking any other creature nearby; All undead spirits such as Wraiths or Ghosts grow stronger, adding 2 dice to any roll and turn on the nearest entity they can find; Kindred, Thin-Bloods and Ghouls feel a shiver run down their spine and are stunned for 1 Round unless they pass their Resistance Roll; Any undead constructs suffer 3 points of Aggravated Damage and are stunned for 1 Round; The barrier between the Shadowlands and the world of the living grows thin allowing creatures to temporarily pass through; All Oblivion and Necromancy users add 1 dice to any of their discipline rolls for the remainder of the Scene; Technological devices which utilize electricity are temporarily disabled.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "oblivion", level: 3 }], summary: "Strike ground to cause massive shadowlands effects in 100m radius for 1 scene.", dicePool: "Potence + Oblivion", level: 3, discipline: "potence" },
            { name: "Baited Weakness", description: "Some predators lure in their prey by appearing as an easy meal themselves. This power has two levels of activation. Basic: At its level the user makes a Rouse Check, with no Test roll needed. Once activated the user will appear weak and pathetic to those around him. He will automatically fail any Intimidation attempt but is otherwise not perceived as threatening. Advanced: While the basic level is active the user may then make Eye Contact with a target and perform another Rouse Check. If their Test roll is successful the target will move to attack the individual, overcome with the need to either prove their superiority, feed or simply put the user out of their misery. Once combat is initiated the user benefits from a 2 dice bonus for the first round of combat.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "obfuscate", level: 4 }], summary: "Appear weak to lure attackers, gain combat bonus in first round when attacked.", dicePool: "Obfuscate + Potence", level: 4, discipline: "potence" },
        ],
    },
    presence: {
        clans: [
    ...
    protean: {
        ...
        powers: [
            ...
            // Amalgams
            { name: "Chameleon Cloak", description: "A variation of Obfuscate which uses the power of physical adaptation rather than mental trickery to cloak its user. The user's skin and clothing changes to better hide the vampire. This ability goes beyond mere natural camouflage as the user can sprout fur, change the colouration of his clothing and even modify the texture of his skin if needed (this change provides no benefits other than when it comes to Stealth). The power is treated as an Upgrade and the user can activate its benefits in the same manner as tensing a muscle. Mechanically the user adds 2 dice to any Stealth-related roll when it comes to hiding or blending into a crowd.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "obfuscate", level: 1 }], summary: "Physical adaptation upgrade: +2 dice to Stealth rolls for hiding/blending.", dicePool: "None", level: 1, discipline: "protean" },
            { name: "Curse Of Lycos", description: "Named after a cursed Greek king, this power subjects the victim to a terrible, if temporary fate. If successful, the user inflicts a curse to any victim they bite. The victim will, over the course of a week, develop animalistic features (usually those most closely associated with the user) and feel a strong preference towards raw or bloody meat. The physical mutations will slowly disappear after the following week without any lasting harm brought upon the victim. Kindred use this power as a form of blackmail on helpless mortals who have no idea the effects are only temporary.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "blood sorcery", level: 1 }], summary: "Bite curse causing week-long animalistic transformation in victim.", dicePool: "Blood Sorcery + Protean", level: 1, discipline: "protean" },
            { name: "Feral Instincts", description: "The vampire is perfectly adapted to their surroundings, feeding on the local wildlife to better hunt its prey. Whenever the user feeds on an animal his senses alter to those of the animal they fed from. The user can voluntarily apply those senses as he chooses while discounting those he might not want. For instance, a mole would have a great sense of smell but horrible eyesight, so it would only be prudent for the Kindred to adopt its sense of smell. Mechanically for each different animal the user consumes, they add 1 dice to any Awareness roll, the bonuses of which are accumulative and last until the end of the night.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "animalism", level: 2 }], summary: "Feeding on animals grants cumulative +1 dice to Awareness per animal type.", dicePool: "None", level: 2, discipline: "protean" },
            { name: "Curse Of Years", description: "As the vampire places their hands on a mortal it seems time progresses rapidly for the victim, essentially ageing them at a rapid pace. If successful, the target is aged by a factor of up to 10 years per dot the user has in Celerity. Unfortunately, the power does not affect Kindred or children (those under the age of 18). Ghouls are impacted but nothing changes for them unless they stop receiving their master's blood in which case all the years catch up with them.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "celerity", level: 2 }], summary: "Age mortals by up to 10 years per Celerity dot through touch.", dicePool: "Celerity + Protean", level: 2, discipline: "protean" },
            { name: "Waste Not", description: "The Kindred places his hand on a corpse only for it to liquify into gore. If successful, the user will liquify a corpse into blood. Bone, skin, flesh, organs and other body parts will also transform into pure blood through this process, obscuring evidence or simply providing the Kindred with ample amounts of food. The average weight of a human is around 70 kilograms (150 pounds) which would create roughly 70 litres (18 gallons) of blood. Do note that, unless properly captured, the blood will leave behind a disconcerting scene, by simple virtue of its quantity.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "oblivion", level: 1 }], summary: "Ritual: Liquify corpse into blood for feeding or evidence destruction.", dicePool: "Oblivion + Vicissitude", level: 1, discipline: "protean" },
            { name: "Coat Of A Thousand Tears", description: "There are numerous reasons why one wouldn't want to be taken alive by the Fiends. This horrid ritual is somewhere at the top of the list. For this ritual to work a restrained (and living) or torpored individual is needed. During the ritual, the user will use their fleshcrafting abilities to remove the victim's internal organs, bones and flesh, but leave the skin, vocal cords and heart undamaged. The heart will be contained in a flesh sack and moved underneath the skin to the 'flesh suits' back. The user will then strip down, put the flesh suit on them and swallow the vocal cords. In this guise, they will look and sound exactly like their victim. Worse still, as the victim's heart is preserved, the flesh suit is technically still alive in a fashion (although the victim likely very much wishes they weren't) and so the aura the user produces mimics that of the victim while obscuring their own.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dominate", level: 2 }], summary: "Ritual: Create flesh suit from victim for perfect disguise with victim's aura.", dicePool: "Dominate + Protean", level: 2, discipline: "protean" },
            { name: "Shatter The Mask", description: "This devastating power strips away all pretense of civilization from a target, revealing the primal beast that lurks beneath the surface. The vampire combines their mastery over animals with shapeshifting abilities to force others into a state of savage, bestial fury that makes any attempt at maintaining the Masquerade impossible. The target's veneer of humanity crumbles as their inner beast takes control.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "animalism", level: 3 }], summary: "Force target into bestial state that makes Masquerade maintenance impossible.", dicePool: "Protean + Animalism", level: 4, discipline: "protean" },
            { name: "Terra Non-Grata", description: "The vampire transforms into a creature of perfect elemental fury, combining the shifting mastery of flesh with deadly toxins that seep from every pore. When activated, the user's body undergoes a horrific transformation, taking on aspects of poisonous creatures while secreting deadly venoms that make the very earth they stand upon toxic to all life. The vampire's form becomes a living embodiment of environmental contamination, their mere presence turning fertile ground into a wasteland that repels all natural life.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "quietus", level: 3 }], summary: "Transform into poisonous creature form that contaminates the environment.", dicePool: "Protean + Quietus", level: 3, discipline: "protean" },
            { name: "Pestilence", description: "The vampire combines their dominion over animals with shapeshifting abilities to become a living plague vector or transform creatures into carriers of supernatural disease. When activated, the vampire can either transform their own body into a writhing mass of disease-bearing vermin, insects, and parasites, or touch animals to imbue them with virulent supernatural plagues. Infected animals become aggressive carriers that spread mystical diseases to mortals and even other supernatural creatures. The vampire can control the nature and severity of the plague, from debilitating weakness to fatal contagions.", rouseChecks: 3, amalgamPrerequisites: [{ discipline: "animalism", level: 3 }], summary: "Transform into disease incarnate or create plague-carrying animals.", dicePool: "Protean + Animalism", level: 3, discipline: "protean" },
            { name: "True Fey's Touch", description: "This Kindred had mastered an exotic form of Protean wherein he incorporates Fey-like aspects into their already intimidating physique. When manifesting their War Form the user can incorporate Fey-like illusions into their form. The user can modify their War Form using additional options: Earth aspects (Autumn Coat: +3 dice Stealth in natural terrain, Troll Skin: roll dice to reduce Aggravated to Superficial), Air aspects (Goblin Musk: enemies must pass Stamina+Resolve or be stunned, Sandman's Blessing: 10m radius penalty, mortals may fall asleep), Water aspects (Winter's Breath: freezing conditions, Frog Kiss: 10m tongue attack to drag enemies). If not using Protean Remastered, this upgrade simply adds a 2-dice bonus to any Physical AND Social rolls made while in war form.", rouseChecks: 0, amalgamPrerequisites: [{ discipline: "chimestry", level: 3 }], summary: "Enhance war form with fey-like illusions and abilities from earth/air/water aspects.", dicePool: "None", level: 3, discipline: "protean" },
        ],
    },
    "blood sorcery": {
        clans: [
        ...
        powers: [
            ...
            // Amalgam Powers
            {
                ...
                description: "The user had enhanced his normal Blood Sorcery Rituals with Celerity's expediency. The user halves the time it takes to perform Rituals for all powers found under Blood Sorcery.",
                summary: "Upgrade: Halve the time required to perform Blood Sorcery rituals",
                rouseChecks: 0,
                amalgamPrerequisites: [{ discipline: "celerity", level: 1 }],
                dicePool: "None",
                level: 1,
                discipline: "blood sorcery",
            },
    ...
    valeren: {
        ...
        powers: [
            ...
            // Amalgams
            { name: "The Specter Of Justice", description: "The victim is haunted by a spirit only he can see. Although ever present, the spirit only materializes to its victim when they are about to commit an act which is considered morally wrong. If successful, a spirit will materialize in front of the victim every time they are about to commit an act which the Storyteller considers morally wrong. The spirit itself is just a trick and is completely conjured by the mind of the victim (an echo of their subconscious morality). Nobody else can see the spirit or interact with it. The spirit itself is terrifying to the victim and keeps them in check while the power lasts. Mechanically speaking the victim applies a 2 dice penalty to any roll associated with an action that the Storyteller deems morally wrong.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dementation", level: 2 }], summary: "Ritual: Haunting spirit that penalizes morally wrong actions.", dicePool: "Dementation + Valeren", level: 2, discipline: "valeren" },
    ...
    "koldunic sorcery": {
        ...
        powers: [
            ...
            // Amalgams
            { name: "Forceful Resurface", description: "As the Kindred places their hand on soil, an invisible pulse is sent through the surrounding earth. Felt as a small tremor by most, it violently expels those entities hiding underground. If successful, all supernatural entities which are currently hiding or travelling through the earth via supernatural means (such as Earth Meld) are violently forced to the surface, as if the ground itself had grown hostile to their presence. Their bodies are cut and torn during this process. They suffer 1 point of Aggravated Damage while resurfacing and are stunned for the 1Round (a few seconds) after emerging.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "potence", level: 1 }], summary: "Force underground supernatural entities to surface violently with damage.", dicePool: "Koldunic Sorcery + Potence", level: 1, discipline: "koldunic sorcery" },
            { name: "Call The Adept", description: "Using a variation of a Garou ritual, meant to find werewolves who had not yet awoken to their true nature, this power allows the user to call those mortals who possess a magical potential. If successful, then the user lures those with magical potential to himself while placing an obstacle in the way of those attempting to meet them. The obstacle can come in many forms, it could be a locked door, a labyrinth, a puzzle or whatever would reasonably separate the user from their would-be target (left to the player's imagination). Those lured to the user do not have to be mages but could be their descendants, they could be members of a bloodline which used Cainite Sorcery, Garou kinfolk, Fey-touched individuals and more. Regardless of their origin, only individuals who belong to a Koldunic bloodline will be able to pass through or solve the obstacle (so a locked door would open automatically for them, while a puzzle would seemingly solve itself).", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "presence", level: 1 }], summary: "Ritual: Lure magical mortals, only Koldunic bloodline can pass obstacles.", dicePool: "Koldunic Sorcery + Presence", level: 1, discipline: "koldunic sorcery" },
            { name: "Seek The World Vein", description: "The user enters a deep trance and is guided by spirits to a location of significant spiritual power. This power works as an Upgrade and an Ability. As an Upgrade, the user can sense and see Ley Lines when near them (within 10 meters or 30 feet). As an Ability, the user enters a trance-like state in which he will move to a location where a Ley Line can be accessed. When in such a trance they will still be able to operate vehicles, avoid obvious dangers (like walking into traffic) and retain the bare basic communication skills. This trance is broken if the user is attacked, or they reach their desired destination. Once the trance breaks the user will have no memory of their travel to the location and will likely not recognize their new surroundings. Regardless, they are, for all intents and purposes, now standing in front of an active Ley Line.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "auspex", level: 2 }], summary: "Ritual: Trance-guided travel to nearest Ley Line, can sense Ley Lines.", dicePool: "Auspex + Koldunic Sorcery", level: 2, discipline: "koldunic sorcery" },
            { name: "The Maw", description: "The Vampire performs a truly horrid ritual and opens a gateway between the Umbra and the heart of Oblivion itself. For this power to work the user must sacrifice a mortal during the Ritual. If successful, the user will open a small tear into Oblivion itself. This tear will make the local spiritual world dangerous, causing all those entering it or using abilities with a Spiritual tag to halve their dice pool (rounding down). Over time the tear will devour or drive out all local spirits (living or dead, good and bad) and the physical world around the ritual site will start to die off (vegetation will rot, animals will be driven away, human structures will rust and crumble). Eventually, if not upkept the tear will seal itself shut and the area (spiritually and physically) will return to normal, overtime.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "oblivion", level: 4 }], summary: "Ritual: Open tear to Oblivion, devastating local spiritual/physical area, requires mortal sacrifice.", dicePool: "Koldunic Sorcery + Oblivion", level: 4, discipline: "koldunic sorcery" },
        ],
    },
    serpentis: {
        clans: ["Ministry"],
        ...
        powers: [
            ...
            // Amalgams
            { name: "The Scales Of Set", description: "Setites have often debated whether Set was the god of serpents or serpents are the children of Set. This ritual suggests the latter. If successful, the user performs an hour-long ritual which ends with him spitting his vitae onto a patch of bare earth. His blood seeps into the ground and after a few moments dozens of snakes erupt from the soil. The serpents are under his complete mental domination and will follow his every command. Commands do not need to be verbal and the user has a supernatural link with his 'children'. The snakes can be used as spies, to deliver messages or even to attack (although individually each snake poses little threat).", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dominate", level: 2 }], summary: "Ritual: Create dozens of controlled snakes from your vitae and earth.", dicePool: "Dominate + Serpentis", level: 2, discipline: "serpentis" },
            { name: "Dreams Of Worship", description: "The vampire weaves together the powers of concealment and serpentine hypnosis to create powerful dream visions in sleeping targets. By visiting a slumbering victim while hidden by Obfuscate, the vampire can implant religious visions, prophetic dreams, or divine commands that feel utterly real to the dreamer. These dreams often feature the vampire as a divine messenger, prophet, or deity, inspiring fanatical devotion upon awakening.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "obfuscate", level: 3 }], summary: "Implant divine dreams in sleeping targets, inspiring worship and devotion.", dicePool: "Serpentis + Obfuscate", level: 4, discipline: "serpentis" },
            { name: "Idolater Of The False Gods", description: "The Kindred venerates dark powers while maintaining an appearance of divine favor. They can invoke protective blessings that make them appear touched by holiness while actually drawing power from darker sources. The vampire gains resistance to holy symbols and blessed weapons (treating them as normal weapons), and can walk on consecrated ground without penalty. However, they must regularly perform acts of false worship to maintain this protection.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "fortitude", level: 4 }], summary: "Resist holy symbols and consecrated ground through false worship.", dicePool: "Serpentis + Fortitude", level: 4, discipline: "serpentis" },
        ],
    },
    obtenebration: {
        ...
        powers: [
            ...
            // Amalgams
            { name: "Enduring Darkness", description: "Normally Obtenebration users are limited by ambient light when facilitating the formation of their shadow constructs. However, some had learned techniques to overcome such limitations. The user can voluntarily perform an extra Rouse Check when using Obtenebration powers (if you are not using Obtenebration Remastered then this upgrade can be used on any Oblivion power which uses shadow constructs, such as Arms Of Ahriman). If the extra Rouse Check is performed, then the shadow constructs generated can only be disrupted by the light of the sun itself or direct contact with fire.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "fortitude", level: 1 }], summary: "Extra Rouse Check makes shadow constructs only disrupted by sunlight/fire.", dicePool: "Rouse Check", level: 1, discipline: "obtenebration" },
            { name: "Shadow Strike", description: "A narrow set of shadows shoots from the darkened corners of the room to impale the victim. If successful, the user can strike an opponent with missiles made from pure shadows. These projectiles always originate from the darkest corner of any room or open area and their impact is similar to being struck by an arrow. Although each such strike only causes a single point of Aggravated Damage to Mortals and Enhanced Mortals, and 2 points of Superficial Damage (damage can be halved) to Supernatural Creatures, it grows more potent with the user's Obtenebration rating.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "potence", level: 2 }], summary: "Shadow projectiles from dark corners causing damage based on Obtenebration level.", dicePool: "Obtenebration + Potence", level: 2, discipline: "obtenebration" },
            { name: "Abyssal Pilfering", description: "The manifestation of this power can often go unnoticed for hours or even days after it has occurred. If successful the victim loses their shadow for 1 day, per the user's rating in Obtenebration (or Oblivion if you are not using the rest of the Remastered series). Individuals who lost their shadows feel uneasy, like something essential had been stolen from them. They cannot use Obtenebration and Oblivion while without a shadow and mortals who do not possess a shadow will be terrified of sunlight, feeling as though they are on fire when it makes contact with their skin. Luckily, while the pain is very real, no actual physical damage occurs. The user himself is, on the other hand, empowered by the theft and adds 1 dice to all Obtenebration & Oblivion rolls.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "blood sorcery", level: 2 }], summary: "Steal target's shadow, empowering your own shadow powers while debilitating them.", dicePool: "Blood Sorcery + Obtenebration", level: 2, discipline: "obtenebration" },
        ],
    },
    quietus: {
        clans: ["Banu Haqim"],
        ...
        powers: [
            ...
            // Amalgams
            { name: "Judgment Of The Fallen", description: "A pact made between the dead and the undying to bring a killer to justice. To complete this Ritual the user must drink a mixture of blood and ashes. The ashes in question need to belong to a victim of the target. If successful the spirit of the victim forms a pact with the user, to assist them in killing the individual who murdered them (the target). The spirit acts as an ethereal adviser and the user adds 1 dice for all tests related to tracking down and killing the spirit's killer.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "necromancy", level: 1 }], summary: "Ritual: Form pact with murder victim's spirit for revenge guidance.", dicePool: "Necromancy + Quietus", level: 1, discipline: "quietus" },
            { name: "Simmering Revolt", description: "This poison emboldens those lingering under the tyranny of their Cainite masters and allows them to break the chains of servitude, often at the cost of their own lives. If successful, the user's blood is laced with a poison that alters the drinker's perception of reality. Those who drink from the user will start to become antagonistic when in the presence of their true master(s) (in the case of Ghouls) or those who originally blood-bonded them. Worse still they are capable of transmitting this poison to others who drink from them in turn. Initially, the effect manifests itself as discomfort, progressing to anger & hatred and finally a full break occurs wherein the victim enters a Frenzy and attacks their supposed master(s).", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "animalism", level: 2 }], summary: "Blood poison causing ghouls/blood bonded to frenzy against masters.", dicePool: "Animalism + Quietus", level: 2, discipline: "quietus" },
            { name: "Flower of Alamut", description: "The Banu Haqim are the undisputed blade masters of the Cainite world. Many have sought to imitate their fighting style, but few can hope to ever equal their mastery. If successful, the user masterfully cuts the tendons in one of the target's limbs, immobilising them and leaving them helpless. For every 2 successes, after achieving the test's minimum requirements, the user can immobilize an additional limb (arms, legs, tentacles, wings, tails...). Each such strike causes 1 point of Aggravated Damage in addition to the power's normal effects. Additional damage modifiers are otherwise not applied as the user is trying to incapacitate rather than kill the target.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "celerity", level: 2 }], summary: "Immobilize limbs with precise tendon cuts, +1 Aggravated damage per limb.", dicePool: "Celerity + Quietus", level: 2, discipline: "quietus" },
            { name: "Terra Non-Grata", description: "The vampire transforms into a creature of perfect elemental fury, combining the shifting mastery of flesh with deadly toxins that seep from every pore. When activated, the user's body undergoes a horrific transformation, taking on aspects of poisonous creatures while secreting deadly venoms that make the very earth they stand upon toxic to all life. The vampire's form becomes a living embodiment of environmental contamination, their mere presence turning fertile ground into a wasteland that repels all natural life.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "protean", level: 3 }], summary: "Transform into poisonous creature form that contaminates the environment.", dicePool: "Quietus + Protean", level: 3, discipline: "quietus" },
            { name: "Moon Kissed Blades", description: "The user coats a blade in his own vitae. Any nick or cut inflicted causes visions of madness to haunt the victim. If successful, the user smears a blade with his blood. For the rest of the evening, any individual injured by the blade will develop the same Mental Derangement the user possesses and will be unable to shake it for the next 3 nights. This form of madness also marks the victim within the Madness Network and the user can instinctively trace down his target, regardless of the distance between them.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dementation", level: 3 }], summary: "Coat blade with vitae to inflict madness and enable tracking of victims.", dicePool: "Quietus + Dementation", level: 3, discipline: "quietus" },
            { name: "Dominion's End", description: "This blood curse is subtle but relentless. Over time it will weaken and destroy those who rely on Dominate. If successful, the target is cursed for the next 2 weeks. During this time their curse will grow progressively worse, each time they use any form of Dominate power. 1st use: the user grows hungrier even if they passed their Rouse check. 2nd use: the power fails automatically. 3rd use: the user must roll two additional Rouse checks. 4th use: the user marks half of their unmarked Willpower squares with Aggravated Damage. 5th use: the user immediately enters an Anger Frenzy and the power fails. 6th use: the user's mouth continuously fills with their blood until the curse passes. 7th use: the user's eyes liquefy, the power fails, they receive one point of Aggravated Health Damage and are blinded until the curse passes.", rouseChecks: 1, amalgamPrerequisites: [{ discipline: "dominate", level: 3 }], summary: "Ritual: Blood curse that progressively weakens Dominate users over 2 weeks.", dicePool: "Quietus + Dominate", level: 3, discipline: "quietus" },
            { name: "The Beheading", description: "The user cuts his palm on the blade, allowing the vitae to bloody it before focusing on the blade itself. Once they are ready to strike the blade cuts the air with incredible swiftness, its edge an extension of the Vampire's own body. The blade cuts through stone, metal and flesh, even that of an elder, with horrifying ease. To perform this ability the following is needed: The user must possess a sword or large blade. The user must cut their own palm on the blade and allow the vitae to cover the weapon (2 Rouse Checks). The user then teleports to the target (in the same manner as if they were using Blink) and must successfully strike it using a Dexterity + Melee roll. If all these conditions are met the user will automatically inflict 5 points of Aggravated Health Damage on a target. This damage cannot be negated or reduced by any powers which are not ranked as Level 5 or higher. The user can also use this attack to cut through any material, be it physical or spiritual, so even spiritual entities such as Wraiths are not safe from its terrible power. Once the damage is made the blade shatters into a dozen smaller pieces.", rouseChecks: 2, amalgamPrerequisites: [{ discipline: "celerity", level: 4 }], summary: "Teleport strike with vitae-enhanced blade dealing 5 Aggravated damage, cuts through any material.", dicePool: "Celerity + Quietus", level: 4, discipline: "quietus" },
        ],
    },
    spiritus: {
